...
?><div class="row-fluid">
  <div class="span12">
      <div class="w-box">
        ...
        <div class="formSep">
          <dl class="dl-horizontal">
            <dt><?=Util::formataTexto($model->getAttributeLabel('opcao'));?></dt>
            <dd><?=Util::formataTexto($model->opcao)?></dd>
          </dl>
        </div>
        <div class="formSep">
          <dl class="dl-horizontal">
              ...
              <dl class="dl-horizontal">
                  ...
                  <dd>
                    ...
                    if(Yii::app()->user->obj->group->temPermissaoAction($this->id,'update')){
                        ?>
                        <a class="btn" href="<?php echo $this->createUrlRel('update',array('id'=>$model->idinvista));?>"><i class="icon-edit "></i> Editar</a>
                        <?
                    }
                    ?>          
                    <?
