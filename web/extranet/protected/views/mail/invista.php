        ...
        <div style="margin-top:20px; padding:20px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="4">
            <tr class="fundo">
              ...
              <td width="77%"><?=htmlentities($invista->nome);?></td>
            </tr>
            <tr>
              <td><strong>E-mail:</strong></td>
              <td><?=htmlentities($invista->email);?></td>
            </tr>
            <tr class="fundo">
              <td><strong>Telefone:</strong></td>
              <td><?=htmlentities($invista->telefone);?></td>
            </tr>
            <tr>
              <td><strong>Endereço:</strong></td>
              <td><?=htmlentities($invista->endereco);?></td>
            </tr>
            <tr class="fundo">
              <td><strong>Opção</strong></td>
              <td><?=htmlentities($invista->opcao);?></td>
            </tr>
          </table>
        </div>
      </div>
