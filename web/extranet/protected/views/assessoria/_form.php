<div class="form">
  ...
  <div class="formSep">
    <dl class="dl-horizontal">
      ...
      <dd> <?php echo $form->textArea($model, 'texto',array('rows'=>'10','class'=>'input-xxlarge')); ?> </dd>
    </dl>
  </div>
  <div class="formSep">
    <dl class="dl-horizontal">
      <dt><?php echo $form->labelEx($model,'icone',array('class'=>'control-label')); ?> </dt>
      <dd>
        <?php
      ...
      <dd style="margin-top: 10px"><strong>Tamanho máximo:</strong> 105x105px</dd>
    </dl>
  </div>
  <div class="formSep">
    <dl class="dl-horizontal">
