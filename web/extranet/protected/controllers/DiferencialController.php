...
class DiferencialController extends GxController {

	
    public function getRepresentingFields(){
		return Diferencial::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Diferencial'),
		));
	}

	public function actionCreate() {
		$model = new Diferencial;
        
		if (isset($_POST['Diferencial'])) {
			$model->setAttributes($_POST['Diferencial']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->iddiferencial,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Diferencial'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->iddiferencial,'success'=>'update')));
			}
		}
	...
	{
		$model=Diferencial::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		if(isset($_GET['o']) && isset($_GET['f']) ){
        	...
        	$criteria->order = 'iddiferencial desc';
        }
		...
		$dataProvider = new CActiveDataProvider('Diferencial', array(
            'criteria'=>$criteria,
			'pagination' => array(
