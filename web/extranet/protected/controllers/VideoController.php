...
class VideoController extends GxController {

	
    public function getRepresentingFields(){
		return Video::representingColumn();
	}
		...
		if (isset($_POST['Video'])) {
			...
			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					...
					$this->redirect($this->createUrlRel('view',array('id' => $model->idvideo,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Video'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idvideo,'success'=>'update')));
			}
		}
