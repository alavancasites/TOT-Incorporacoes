...
class InvistaController extends GxController {

	
    public function getRepresentingFields(){
		return Invista::representingColumn();
	}
    
	public function actionView($id) {
		$this->render('view', array(
			'model' => $this->loadModel($id, 'Invista'),
		));
	}
	...
	public function actionCreate() {
		...
		if (isset($_POST['Invista'])) {
			$model->setAttributes($_POST['Invista']);

			if ($model->save()) {
				if (Yii::app()->getRequest()->getIsAjaxRequest())
					Yii::app()->end();
				else
					$this->redirect($this->createUrlRel('view',array('id' => $model->idinvista,'success'=>'create')));
			}
		}
        else{
	...
	public function actionUpdate($id) {
		...
		if (isset($_POST['Invista'])) {
			...
			if ($model->save()) {
                $this->redirect($this->createUrlRel('view',array('id' => $model->idinvista,'success'=>'update')));
			}
		}
	...
	{
		$model=Invista::model()->findByPk($id);
		if($model===null)
	...
	public function actionIndex() {
		...
		$dataProvider = new CActiveDataProvider('Invista', array(
            'criteria'=>$criteria,
			'pagination' => array(
